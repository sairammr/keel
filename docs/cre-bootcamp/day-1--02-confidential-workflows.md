...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/day-1/02-confidential-workflows.html
...
const onCronTrigger = async (runtime: TeeRuntime): Promise => {
...
const initWorkflow = (config: Config): Workflow => {
