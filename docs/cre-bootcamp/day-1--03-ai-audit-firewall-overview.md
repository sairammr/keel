...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/day-1/03-ai-audit-firewall-overview.html
...
![AI Audit Firewall workflow](../assets/CRE-AI_audit-firewall.png)![AI Audit Firewall workflow](../assets/CRE-AI_audit-firewall.png)

Want to explore this workflow yourself? The complete workflow definition is available as a [JSON file](../assets/CRE-AI_Audit_Firewall.json). You can import it into <https://cre.solange.dev/> — a visual GUI tool for CRE workflows — to inspect and interact with the flow step by step.
