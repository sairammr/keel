...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/day-1/04-ai-audit-firewall-code.html
...
```typescript
const writeVerdictOnChain = async (runtime, result): Promise => {
