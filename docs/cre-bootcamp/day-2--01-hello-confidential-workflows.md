...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/day-2/01-hello-confidential-workflows.html
...
```bash
Secret created: secret_id=API_TOKEN, owner=, namespace=main
