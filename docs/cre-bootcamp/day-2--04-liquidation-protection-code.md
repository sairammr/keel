...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/day-2/04-liquidation-protection-code.html
...
```typescript
export const onCronTrigger = async (runtime: TeeRuntime): Promise => {
