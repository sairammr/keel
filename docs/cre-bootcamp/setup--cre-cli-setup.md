...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/setup/cre-cli-setup.html
...
![CRE Signup](../assets/cre-signup.png)![CRE Signup](../assets/cre-signup.png)
...
![CRE Successful Login](../assets/cre-successful-login.png)![CRE Successful Login](../assets/cre-successful-login.png)
...
> **Note** : Deploying Confidential Workflows is currently in Private Beta and requires separate enrollment (see the [Day 2 wrap-up](../day-2/06-wrap-up.html)). However, **local simulation requires no special access** — which is exactly how we run everything in this bootcamp.
