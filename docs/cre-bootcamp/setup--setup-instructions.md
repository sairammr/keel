...
Source: https://smartcontractkit.github.io/CRE-Confidential-bootcamp/setup/setup-instructions.html
...
### Required
  ...
  * **CRE account** \- Sign up at [cre.chain.link](https://cre.chain.link) and complete `cre login` (see [CRE CLI Quick Setup](./cre-cli-setup.html))
